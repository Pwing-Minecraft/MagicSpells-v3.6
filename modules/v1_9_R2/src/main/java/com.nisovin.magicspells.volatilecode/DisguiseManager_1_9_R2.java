...
public class DisguiseManager_1_9_R2 /*extends DisguiseManager*/ {
...
//	
//	public DisguiseManager_1_9_R2(MagicConfig config) {
//		super(config);
...
//			((EntityItem)entity).setItemStack(new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(id > 0 ? id : 1), 1, data));
//			
//		}
//		
//		if (entity != null) {
