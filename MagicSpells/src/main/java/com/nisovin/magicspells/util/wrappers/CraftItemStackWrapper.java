...
public class CraftItemStackWrapper {
	...
	static {
		...
		try {
			asNMSCopyMethod = ReflectionUtils.getMethod(targetClass, "asNMSCopy", net.minecraft.server.v1_12_R1.ItemStack.class);
		...
		try {
			asCraftCopyMethod = targetClass.getDeclaredMethod("asCraftCopy", net.minecraft.server.v1_12_R1.ItemStack.class);
